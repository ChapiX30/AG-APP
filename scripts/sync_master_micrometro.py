# -*- coding: utf-8 -*-
"""
Sincroniza Formato Micrometro Exteriores.xlsm con la app (prefijo AGD).
...
DEFAULT_MASTER = Path(r"C:\Users\AG\Desktop\FORMATOS AG\Formato Micrometro Exteriores.xlsm")
...
def fetch_json(url: str) -> dict:
    req = urllib.request.Request(url, headers={"User-Agent": "AG-MicrometroSync/1.0"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync master Micrómetro Exteriores")
    ...
    try:
        ...
        print("Uso: D4=AGD  E4=número  F4=año | J11=mm/in | G11=alcance")
        return 0
