# -*- coding: utf-8 -*-
"""
Sincroniza Formato Vernier.xlsm con la app (prefijo AGD).

Respaldo cuando Power Query no puede conectar.
"""
...
DEFAULT_MASTER = Path(r"C:\Users\AG\Desktop\FORMATOS AG\Formato Vernier.xlsm")
...
def fetch_json(url: str) -> dict:
    req = urllib.request.Request(url, headers={"User-Agent": "AG-VernierSync/1.0"})
...
def es_patron_dim(p: dict) -> bool:
    ...
    return "BLOQUE" in desc or "GAUGE" in desc
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync master Vernier")
    ...
    try:
        ...
        if wb.ReadOnly:
            raise RuntimeError("Abierto como solo lectura. Ci̩rralo en Excel e intenta de nuevo.")
        ...
        print("Uso: D4=AGD  E4=numero  F4=ano | J12=mm/in | F12=alcance")
        return 0
