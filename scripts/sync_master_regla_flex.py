# -*- coding: utf-8 -*-
"""
Sincroniza Formato Regla Flex.xlsm con la app (prefijo AGD).
...
DEFAULT_MASTER = Path(r"C:\Users\AG\Desktop\FORMATOS AG\Formato Regla Flex.xlsm")
...
def fetch_json(url: str) -> dict:
    req = urllib.request.Request(url, headers={"User-Agent": "AG-ReglaFlexSync/1.0"})
...
def es_patron_dim(p: dict) -> bool:
    ...
    return any(k in desc for k in ("BLOQUE", "GAUGE", "REGLA", "RETICULA", "FLEX", "CINTA"))
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync master Regla Flex")
    ...
    try:
        ...
        print("Uso: D4=AGD  E4=numero  F4=ano | J11=mm/in | F10=alcance | J9=division")
        return 0
