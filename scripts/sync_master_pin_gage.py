# -*- coding: utf-8 -*-
"""
Sincroniza Formato Pin Gage.xlsm con la app (prefijo AGD).
...
DEFAULT_MASTER = Path(r"C:\Users\AG\Desktop\FORMATOS AG\Formato Pin Gage.xlsm")
...
def fetch_json(url: str) -> dict:
    req = urllib.request.Request(url, headers={"User-Agent": "AG-PinGageSync/1.0"})
...
def es_patron_dim(p: dict) -> bool:
    ...
    return any(k in desc for k in ("BLOQUE", "GAUGE", "MICROM", "PIN"))
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync master Pin Gage")
    ...
    try:
        ...
        print("Uso: D4=AGD  E4=numero  F4=ano | J10=mm/in | J9=division | J11=incremento | A18=nominal")
        return 0
